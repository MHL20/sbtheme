...
<div style="color:#fff; font-size:12px; font-weight:bold; padding:0px; margin:0; text-align:center; background:#333333;">Basic Configuration</div>
<p>
...
<div style="color:#fff; font-size:12px; font-weight:bold; padding:0px; margin:0; text-align:center; background:#333333;">Twitter App Configuration(Must Fill This Correctly)**</div>
<p>
...
<div style="color:#fff; font-size:12px; font-weight:bold; padding:0px; margin:0; text-align:center; background:#333333;">Advanced Configuration</div>
<p>
...
<p>
	...
	name="<?php echo $this->get_field_name('borderRadius');?>"
        value="<?php echo !empty($borderRadius) ? $borderRadius : "0"; ?>" />
</p>
<p>
...
<?php
    ...
    public function widget($args, $instance) {
        ...
        $data .= "
<div id='advanced_twitter_followers_widget'>
		<div id='twitterWidget' class='twitterFollowers'>
			<div class='likebox-border'>
				<div id='likebox' ";
	if($border=="true"){
	$data .= "border: $borderColorl ";
	$data .= "px solid $borderColor; ";
	}
	$data .= ">";
        if($header == "true"){
        $data .= "<div class='findus'>$headerText</div>";
        }
    $data .= "

<ul class='small-block-grid-3 medium-block-grid-4 large-block-grid-6 sb-twitter-grid'>";
...
$data .= "<li><a href='//twitter.com/$followURL' target='_blank'><img src='$followImg' title='$followTitle'></a></li>";
}
}
