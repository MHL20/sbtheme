...
wp_register_widget_control( 'Untappd beerFeed', 'myBeerFeed_control', '' );   
wp_register_widget_control( 'Untappd breweryFeed', 'myBreweryFeed_control', '' );   
wp_register_widget_control( 'Untappd venueFeed', 'myVenueFeed_control', '' );   
wp_register_widget_control( 'Untappd userFeed', 'myUserFeed_control', '' ); 

wp_register_sidebar_widget( 'Untappd beerFeed', 'widget_myBeerFeed', '' );  
wp_register_sidebar_widget( 'Untappd breweryFeed', 'widget_myBreweryFeed', '' );
wp_register_sidebar_widget( 'Untappd venueFeed', 'widget_myVenueFeed', '' );
wp_register_sidebar_widget( 'Untappd userFeed', 'widget_myUserFeed', '' );
